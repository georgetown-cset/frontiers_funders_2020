create or  replace table frontiers_forecasting.reg_data_2019 as
WITH
corp_0 as (
...
year >= 2005
 ...
 science_map.dc5_cluster_assignment_latest) cl ON c.merged_id =
cl.article_id
),
...
select id, cit_id, year, 2019 - year as  cit_age   from
...
inner join (select * from frontiers_forecasting.backcasting_data_2019) p
