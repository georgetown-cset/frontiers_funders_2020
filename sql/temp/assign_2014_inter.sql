WITH cl as (
/* CHANGE LATER */
select cluster as cluster_id, article_id from frontiers_forecasting.core_2014_latest
),
...
paper_cur as (
select merged_id as id from gcp_cset_links_v2.corpus_merged  where year <= 2014
),
/* get papers with age */
